...
alias up='$aurhelper -Syu && flatpak update' # update system/package/aur
...
alias install='$aurhelper -S'
alias myip="ip -f inet address | grep inet | grep -v 'lo$' | cut -d ' ' -f 6,13 && curl -4 ifconfig.me && echo ' Public IPv4'"
